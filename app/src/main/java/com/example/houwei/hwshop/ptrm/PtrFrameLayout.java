...
import com.example.houwei.hwshop.ptrm.indicator.PtrIndicator;
import com.example.houwei.hwshop.ptrm.util.PtrCLog;
 ...
 * It defines {@link com.example.houwei.hwshop.ptrm.PtrUIHandler}, which allows you customize the UI easily.
 */
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                boolean canFooterMoveUp = mPtrHandler != null && mFooterView != null // The footer view could be null, so need double check
                        && mPtrHandler instanceof PtlmHandler && ((PtlmHandler) mPtrHandler).checkCanDoLoadMore(this, mContent, mFooterView) && (mMode.ordinal() & 2) > 0;
    ...
    private void performRefresh() {
        ...
        if (mPtrHandler != null) {
            if (mPtrIndicator.isHeader()) {
                ...
                if (mPtrHandler instanceof PtlmHandler) {
                    ((PtlmHandler) mPtrHandler).onLoadMoreBegin(this);
                }
            }
        }
    }
