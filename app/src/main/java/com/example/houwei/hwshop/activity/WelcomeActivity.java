...
import com.example.houwei.hwshop.MainActivity;
import com.example.houwei.hwshop.R;
import com.example.houwei.hwshop.utils.SharedPreferenceUtil;
...
//        boolean isFirstOpen = SharedPreferencesUtil.getBoolean(this, SharedPreferencesUtil.FIRST_OPEN, true);
        boolean isFirstOpen = SharedPreferenceUtil.getSharedPreferenceUtil(this).getInfoFromShared("isFirstRun",true);
        // 如果是第一次启动，则先进入功能引导页
        if (isFirstOpen) {
